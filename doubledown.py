...
accuracy = int(input("Please enter the level of accuracy used in simulation:(10 to 50, where 50 will take some time with higher accuracy)\n"))
numofGambler = int(input("Please enter the number of gamblers used in simulation:(10 to 500, where 500 will take some time with higher accuracy)\n"))
